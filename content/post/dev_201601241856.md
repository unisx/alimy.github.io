...
(注意：文章引用[***这里***](http://blog.csdn.net/iiisan/article/details/399431# "How to write make file")，我只是为了方便以后查找，重新编辑收录博客。Make 是一个功能强大的工具，即使有那么点瑕疵，也不妨碍她的实用价值，非常值得深入研究使用)
